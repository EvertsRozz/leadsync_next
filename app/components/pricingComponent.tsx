...
function PricingComponent() {
  return (
    <div className="mx-0 mt-2 grid grid-cols-1 gap-20 md:mx-24 md:mt-24 md:grid-cols-2">
      ...
      <div className="grid grid-cols-1 flex-col gap-20 md:col-span-2 md:grid-cols-2 md:flex-row">
        ...
        <div className="order-1 flex w-full flex-col items-end justify-center md:order-2">
          <PricingComponentBenefits
            span="Efficient"
            spanColor="83FF48"
            header="Email Delivery"
